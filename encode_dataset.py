...
testset = torchvision.datasets.CIFAR10(root='./data', train=False,
                                        download=True, transform=transform)
root="/home/mila/t/thomas.jiralerspong/delta_ai/CNN_autoencoder/scratch/cnn_autoencoder/cifar"

autoencoder = create_model("original_wider_less_channels")
autoencoder.load_state_dict(torch.load(f"/home/mila/t/thomas.jiralerspong/delta_ai/CNN_autoencoder/scratch/cnn_autoencoder/weights/original_wider_less_channels/autoencoder.pkl"))
